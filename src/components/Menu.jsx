...
export default function Menu() {
  const menuItems = [
    ...
    {
      title: 'Duck Confit',
      description: 'Slow-cooked duck leg with crispy skin, served with roasted fingerling potatoes',
      price: '32.99',
      image: 'https://images.unsplash.com/photo-1547424450-75ec164925d3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
      rating: '4.8',
      category: 'Meat',
    },
    {
